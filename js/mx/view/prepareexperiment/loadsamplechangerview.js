...
LoadSampleChangerView.prototype.createSampleChangerWidget = function (sampleChangerName, beamlineName) {
    ...
    if (sampleChangerName == "P11SC") {
        this.sampleChangerWidget = new P11SCWidget(data);
    }
...
LoadSampleChangerView.prototype.changeSampleChangerWidgetByBeamline = function (beamlineName) {
    ...
    if (newBeamline.length > 0) {
        ...
        } else if (EXI.credentialManager.getCredentials()[0].properties.name.indexOf("DESY") != -1) {
            this.createSampleChangerWidget("P11SC",beamlineName);
        }else {
...
LoadSampleChangerView.prototype.reloadSampleChangerWidget = function () {
    ...
    $("#" + this.id + "-scw-label").html(this.sampleChangerWidget.beamlineName + " (" + this.sampleChangerWidget.label + ")");
    this.panel.doLayout();
}

 ...
 */
function CollectedSpecimenWidget(args){
	...
	/** Specimen Grid **/
	this.specimenGrid = new CollectedSpecimenGrid({
											minHeight 			: 425,
 ...
 */
CollectedSpecimenWidget.prototype.getContainerLayoutConfiguration = function(dataCollections){
 ...
 * **/
CollectedSpecimenWidget.prototype.getPanel = function(){
...
// CollectedSpecimenWidget.prototype.input = function() {
// 	return {
...
// CollectedSpecimenWidget.prototype.test = function(targetId) {
// 	var CollectedSpecimenWidget = new CollectedSpecimenWidget({
// 		height : 500,
// 		width : 1000
// 	});
// 	BIOSAXS.proposal = new Proposal(CollectedSpecimenWidget.input().proposal);
// 	var experiment = new Experiment(CollectedSpecimenWidget.input().experiment);
// 	var panel = CollectedSpecimenWidget.getPanel();
// 	panel.render(targetId);
// 	CollectedSpecimenWidget.refresh(experiment);
...
window.CollectedSpecimenWidget = CollectedSpecimenWidget;

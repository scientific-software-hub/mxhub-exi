 ...
 */
function CollectedMeasurementGrid(args) {
	this.id = BUI.id();
...
CollectedMeasurementGrid.prototype.load = function(dataCollections) {
...
CollectedMeasurementGrid.prototype.getPanel = function(){
    var _this = this;
...
// CollectedMeasurementGrid.prototype._prepareData = function(measurements, experiments) {
// 	var data = [];

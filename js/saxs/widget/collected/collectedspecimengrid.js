function CollectedSpecimenGrid(args) {
	this.id = BUI.id();
	this.height = 500;
...
CollectedSpecimenGrid.prototype._prepareData = function(dataCollections) {
	var data = [];
...
CollectedSpecimenGrid.prototype.deselectAll = function() {
	this.grid.getSelectionModel().deselectAll();
};

CollectedSpecimenGrid.prototype.selectById = function(specimenId) {
	this.grid.getSelectionModel().deselectAll();
...
CollectedSpecimenGrid.prototype.getStore = function() {
	return this.store;
};

CollectedSpecimenGrid.prototype.getPlugins = function() {
	var _this = this;
...
CollectedSpecimenGrid.prototype._getRowCombo = function() {
	var data = [];
	for ( var i = 1; i <= 8; i++) {
		data.push({
			rowNumber : i,
...
CollectedSpecimenGrid.prototype._getColumnCombo = function() {
	var data = [];
	for ( var i = 1; i <= 12; i++) {
		data.push({
			columnNumber : i
...
CollectedSpecimenGrid.prototype._getSlotColumBombo = function() {
	if (this.experiment){
...
CollectedSpecimenGrid.prototype.getPanelByExperiment = function(experiment) {
	this.experiment = experiment;
	var data = this._prepareData(experiment);
	return this.getPanel(data);
};

CollectedSpecimenGrid.prototype.refresh = function(dataCollections) {
	
	this.dataCollections = dataCollections;
	_.map(dataCollections, function(o){ 
        if(o.Macromolecule_macromoleculeId){            
		    o.acronym = o.Macromolecule_acronym;
        } else {
			o.acronym = "Buffers";
		}
...
CollectedSpecimenGrid.prototype.getPanel = function() {
...
CollectedSpecimenGrid.prototype.input = function() {
	return {
...
CollectedSpecimenGrid.prototype.test = function(targetId) {
	var CollectedSpecimenGrid = new CollectedSpecimenGrid({
		height : 400,
		maxHeight : 400,
		width : 1000
	});
	BIOSAXS.proposal = new Proposal(CollectedSpecimenGrid.input().proposal);

	var experiment = new Experiment(CollectedSpecimenGrid.input().experiment);
	var panel = CollectedSpecimenGrid.getPanelByExperiment(experiment);
